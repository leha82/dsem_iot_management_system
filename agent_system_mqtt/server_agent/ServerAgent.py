...
if __name__ == "__main__":
    ...
    sensor_collector = SensorCollector.SensorCollector(dbm, server_ip, port_sensor, mqtt_broker_ip)
    actuator_collector = ActuatorController.ActuatorController(dbm, server_ip, port_actuator, mqtt_broker_ip)
